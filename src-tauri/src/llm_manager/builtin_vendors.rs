...
pub const BUILTIN_VENDORS: &[BuiltinVendor] = &[
    ...
    BuiltinVendor {
        ...
        notes: "阿里云百炼 API。可用模型: qwen3-max, qwen-plus, qwq-plus",
        max_tokens_limit: None,
    ...
    BuiltinVendor {
        ...
        notes: "智谱AI 开放平台。可用模型: glm-4.6, glm-4.5, glm-4-flash",
        max_tokens_limit: None,
    ...
    BuiltinVendor {
        ...
        notes: "火山方舟大模型平台。注意: 需要先在控制台创建接入点获取模型 ID",
        max_tokens_limit: None,
    ...
    BuiltinVendor {
        ...
        notes: "MiniMax API。可用模型: MiniMax-M2.1, MiniMax-M2.1-lightning, MiniMax-M2",
        max_tokens_limit: None,
    ...
    BuiltinVendor {
        ...
        notes: "OpenAI 官方 API。可用模型: gpt-5.2/5.1/5/mini/nano, o3-pro/o3/o3-mini/o4-mini",
        max_tokens_limit: None,
    ...
    BuiltinVendor {
        ...
        notes: "Google Gemini API (OpenAI 兼容模式)。可用模型: gemini-3-pro/flash, gemini-2.5-pro/flash/flash-lite",
        max_tokens_limit: None,
...
pub const BUILTIN_MODELS: &[BuiltinModel] = &[
    ...
    // ===== 字节豆包模型 =====
    // 注意: 豆包需要先在火山方舟控制台创建接入点，获取 endpoint_id 后替换 model 字段
    BuiltinModel {
        id: "builtin-doubao-1.8-pro",
        vendor_id: "builtin-doubao",
        label: "豆包 1.8 Pro (需替换接入点ID)",
        model: "ep-xxxxxxxx", // 用户需替换为实际接入点 ID
        is_multimodal: false,
        is_reasoning: false,
        supports_tools: true,
    ...
    BuiltinModel {
        ...
        vendor_id: "builtin-minimax",
        label: "MiniMax M2.1 Lightning (快速)",
    ...
    BuiltinModel {
        ...
        temperature: 1.0, // 推理模型不支持 temperature，会被移除
    },
    // --- GPT-5.1 系列 (Codex 优化) ---
    BuiltinModel {
        id: "builtin-gpt-5.1",
