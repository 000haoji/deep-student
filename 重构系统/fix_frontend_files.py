...
print("✅ MainLayout.vue 已修复")

# 检查其他AI相关文件
ai_files = [
    'frontend/src/views/ai/AIModelList.vue',
    'frontend/src/views/ai/AIStats.vue'
]
