...
本项目采用 **AGPL-3.0-or-later** 许可证开源。为了确保项目能够持续发展并在未来可能的商业化路径中保持灵活性（例如提供双重许可、发布企业版等），我们需要明确贡献的授权范围。

提交 Pull Request 即表示您（贡献者）同意以下条款：

1.  **版权归属**：您保留您所提交贡献的版权（Copyright）。
2.  **授权授予**：您授予项目维护者（Deep Student 维护团队）一份永久的、不可撤销的、全球性的、免费的、非独占的版权许可。该许可允许项目维护者：
    *   复制、修改、公开展示、公开运行、分发您的贡献。
    *   **再授权 (Sublicense)**：有权在任何其他许可证（包括但不限于商业闭源许可证、MIT、Apache-2.0 等）下重新发布您的贡献，或将其包含在其他衍生作品中。
3.  **合法性声明**：您保证您拥有提交该贡献的合法权利，且该贡献不侵犯第三方的知识产权。如果您的贡献包含第三方代码，您已并在 PR 中明确说明了其来源和许可证。
4.  **第三方依赖**：引入的第三方依赖必须与 AGPL-3.0 兼容（MIT、Apache-2.0、BSD 等均兼容；GPL-2.0-only 不兼容）。
