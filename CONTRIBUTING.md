...
2.  **版权许可授予**：您授予项目维护者一份永久的、不可撤销的、全球性的、免费的、非独占的版权许可，包括复制、修改、分发及**再授权 (Sublicense)** 的权利。
3.  **专利许可授予**：您授予项目维护者一份永久的、不可撤销的、全球性的、免费的、非独占的专利许可，适用于因您的贡献而必然被侵犯的专利权利要求。如果您对任何实体提起专利侵权诉讼（主张您的贡献构成侵权），则您授予该实体的专利许可自诉讼提起之日起终止。
4.  **合法性声明**：您保证您拥有提交该贡献的合法权利，且该贡献不侵犯第三方的知识产权。如果您的贡献包含第三方代码，需在 PR 中明确说明其来源和许可证。
5.  **AI 生成内容**：如贡献包含 AI 生成的内容，需在 PR 中披露并确认其合规性。
6.  **第三方依赖**：引入的第三方依赖必须与 AGPL-3.0 兼容（MIT、Apache-2.0、BSD 等均兼容；GPL-2.0-only 不兼容）。
